...
sudo pacman -S lolcat fd fzf ripgrep unzip lazygit cmatrix btop fastfetch exa yazi dolphin xautolock grim xclip iwd net-tools tldr wget neovide npm firefox gnome-keyring ncmpcpp mpd mpc libevent gnome-keyring bat okular brightnessctl mako feh go rustup pavucontrol-qt wlroots hypridle imagemagick hyprlock sshfs
