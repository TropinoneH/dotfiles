...
sudo pacman -S lolcat fd fzf ripgrep tree unzip lazygit cmatrix btop neofetch exa ranger dolphin dunst xautolock flameshot arandr lxappearance xclip iwd net-tools tldr wget neovide rofi npm firefox gnome-keyring
