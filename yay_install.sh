...
# yay install
yay -S google-chrome optimus-manager optimus-manager-qt networkmanager-dmenu-git rofi-bluetooth-git mailspring rofi-greenclip notion-app-electron todesk visual-studio-code-bin clang-format-all-git ueberzugpp cava
